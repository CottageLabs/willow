class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("organisation_nested", :stored_searchable), label: I18n.t('willow.fields.organisation_nested'), itemprop: 'organsiation', link_to_search: solr_name("organisation_nested", :facetable)
